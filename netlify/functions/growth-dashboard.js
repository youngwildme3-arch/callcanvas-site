...
<body>
<h1>Ã°ÂÂ¤Â CallCanvas AI Ã¢ÂÂ Autonomous Growth Engine</h1>
<p class="sub">Self-optimizing 24/7 ÃÂ· Last run: ${log?.date || 'Starting up...'}</p>
<div class="grid">
<div class="card"><h2>Active Automations</h2>
<div class="item"><span class="dot"></span>Daily Blog Ã¢ÂÂ 6:00 AM UTC</div>
<div class="item"><span class="dot"></span>Growth Optimizer Ã¢ÂÂ 7:00 AM UTC</div>
<div class="item"><span class="dot"></span>SEO Monitor Ã¢ÂÂ Monday 8:00 AM UTC</div>
</div>
...
<p style="margin-top:24px;color:rgba(240,246,252,.3);font-size:12px">callcanvasai.com ÃÂ· <a href="/" style="color:#0ea5e9">Home</a> ÃÂ· <a href="/blog" style="color:#0ea5e9">Blog</a></p>
</body></html>`;
