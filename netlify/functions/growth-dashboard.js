...
<body>
<h1>🤖 CallCanvas AI — Autonomous Growth Engine</h1>
<p class="sub">Self-optimizing 24/7 · Last run: ${log?.date || 'Starting up...'}</p>
<div class="grid">
<div class="card"><h2>Active Automations</h2>
<div class="item"><span class="dot"></span>Daily Blog — 6:00 AM UTC</div>
<div class="item"><span class="dot"></span>Growth Optimizer — 7:00 AM UTC</div>
<div class="item"><span class="dot"></span>SEO Monitor — Monday 8:00 AM UTC</div>
<div class="item"><span class="dot"></span>Affiliate Tracker — /ref?ref=CODE</div>
</div>
...
<p style="margin-top:24px;color:rgba(240,246,252,.3);font-size:12px">callcanvasai.com · <a href="/" style="color:#0ea5e9">Home</a> · <a href="/blog" style="color:#0ea5e9">Blog</a></p>
</body></html>`;
